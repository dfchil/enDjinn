...
void render_PT(void* data) {
    ...
    int act_rw = enj_qfont_write(proclamation,
      ((int)(vid_mode->width) - txtwidth) / 2, 114,
      PVR_LIST_PT_POLY);
      printf("Proclamation predicted width: %d, actual width %d, vid width %d\n", txtwidth, act_rw, vid_mode->width);
