...
cfg_info:
	...
	@echo "ENJ_PAL4_PVRTEX_FLAGS = ${ENJ_PAL4_PVRTEX_FLAGS}"
	@echo "ENJ_PAL8_PVRTEX_FLAGS = ${ENJ_PAL8_PVRTEX_FLAGS}"
	@echo "ENJ_PAL4_VQ_TW_PVRTEX_FLAGS = ${ENJ_PAL4_VQ_TW_PVRTEX_FLAGS}"
	@echo "ENJ_PAL8_VQ_TW_PVRTEX_FLAGS = ${ENJ_PAL8_VQ_TW_PVRTEX_FLAGS}"
	@echo "                  # Extra pvrtex flags for each palettized texture type"
